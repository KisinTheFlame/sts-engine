...
const POTION_LIST: PotionDef[] = [
  ...
  },
  {
    id: "smoke_bomb",
    name: "烟雾弹",
    // 逃离后不结算战斗奖励；精英/首领战不可使用。战斗内脱离由 sts-combat 处理。
    description: "从非首领战斗中脱身，不获得任何奖励。",
    rarity: "rare",
    targeted: false,
    combatOnly: true,
    effects: [{ kind: "escape" }],
  ...
  // —— 补全批次：硬机制药水 ——
  {
    id: "snecko_oil",
    name: "蛇油",
    description: "抽 5 张牌，并将手牌中所有牌的费用随机变为 0~3（本场有效）。",
    rarity: "rare",
    targeted: false,
    combatOnly: true,
    effects: [{ kind: "draw", amount: 5 }, { kind: "randomize_hand_costs" }],
  },
  {
    id: "distilled_chaos",
    name: "蒸馏混沌",
    description: "打出抽牌堆顶的 3 张牌。",
    rarity: "uncommon",
    targeted: false,
    combatOnly: true,
    effects: [{ kind: "play_top_n", count: 3 }],
  },
  {
    id: "duplication_potion",
    name: "复制药水",
    description: "本回合接下来打出的下一张牌结算两次。",
    rarity: "uncommon",
    targeted: false,
    combatOnly: true,
    effects: [{ kind: "apply_power", power: "duplication", amount: 1, on: "self" }],
  },
  {
    id: "fairy_in_a_bottle",
    name: "瓶中仙灵",
    // 濒死时自动消耗、回 30% 生命（见 sts-combat.ts 的 wouldDie）；手动使用无效果。
