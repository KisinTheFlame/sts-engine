...
| 编队 | 33      | 63                | `ENCOUNTER_BUILDERS` / `ENCOUNTER_SETUP`    |
...
| 指标                      | 第二十一批               | 第二十二批               | 第二十三批           | 第二十四批 | 第二十五批         | 第二十六批             |
| ------------------------- | ------------------------ | ------------------------ | -------------------- | ---------- | ------------------ | ---------------------- |
| `test/golden/traces` 总量 | 268MB                    | 285MB                    | 302MB                | 302MB†     | 348MB              | **388MB**              |
| 对拍例数                  | 16861                    | 17581                    | 18706                | 19831      | 20956              | **22456**              |
| 编队文件数                | 34（20 asc0 + 14 asc19） | 40（20 asc0 + 20 asc19） | 43（+3 第二幕 asc0） | 46         | 49                 | **53**                 |
| `variant0` 冻结文件       | 15×375 + 14×120 行       | 15×375 + 20×120 行       | 18×375 + 20×120 行   | 21×375+…   | 24×375 + 20×120 行 | **28×375 + 20×120 行** |
...
### 未装（6 / 19），按「新机制 / 爆炸半径」排的建议顺序

| 建议批次   | 编队                                                              | 新怪                                         | 为什么这么排                                                                                                                                                                     |
| ---------- | ----------------------------------------------------------------- | -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **二十七** | `gremlin_leader` / `slavers` / `book_of_stabbing`（第二幕三精英） | 地精首领 / 工头 / 刺穿之书                   | **召唤**（`summon`）+ `MINION_LEADER` + **`escapeNext` 的写入点**（第十七批记着「参考里没人写它」，真实游戏由地精首领置位——到这一批才判得了要不要打补丁）+ `miscInfo` 的连刺计数 |
| **二十八** | `champ` / `collector` / `automaton`（第二幕三 Boss）              | 冠军 / 收藏家 / 火炬头 / 青铜机器人 / 青铜球 | 召唤 + `STASIS`（把玩家一张牌扣住）+ 怪物侧 `ARTIFACT 3` 的第二个宿主 + **镀甲的第二个宿主**（DECA/DONU 是第三幕，青铜机器人不带；见下）。**体积最大的一批**，排最后             |
| **二十九** | 第二幕的**爬升度**（另开一个 variant，`ascension = 19`）          | 0                                            | 与第二十一/二十二批同构。⚠ 必须等第二幕的怪装完，否则要来回补 `ascCalibrated`                                                                                                    |
