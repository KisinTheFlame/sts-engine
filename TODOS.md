...
| 批   | 编队                                                     | 新怪物                          | 主要新机制                                           |
| ---- | -------------------------------------------------------- | ------------------------------- | ---------------------------------------------------- |
| 十三 | `small_slimes` `lots_of_slimes`                          | 酸/尖刺史莱姆 M、S 四只         | 黏液牌、脆弱、编队组合抽样（`randomBoolean` / 池抽） |
...
当前 147MB / 9555 例。**最大单个文件仍是 `jaw_worm_horde.jsonl`，48,581,931 字节（46.3MB）**
...
⚠ **例数是随数据变的**，换 variant 就得重量。下面标 ⁂ 的是在**当前布局（9555 例，
variants 19/20 为第十二批的聚焦牌组）**上量的；标 ※ 的是第十一批那版布局（9075 例，
