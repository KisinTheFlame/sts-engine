...
| **贤者之石 / 御守 / 暗石护符那几支**             | 三十四/三十五/三十六 | harness 的**八个遗物轮换**里没有它们（⚠ 这一条现在有解了，见「四、下一步 ⑤」）                                                        |
...
| **仓库总计**            | **116 个文件 / 622MB / 31545 条 trace**                                           |
| **对拍例数**            | **31546**（31545 条 + 1 条「trace 数据自身的不变量」）                            |
| 三幕的文件构成          | 第一幕 asc0 20 + asc19 20；第二幕 asc0 19 + asc19 19；`@tgt1` 23；第三幕 15       |
...
| ⑤   | **遗物 / 药水**                                | 遗物 8 → 168、药水 13 → 42，是**两条最大的空白战线**              | ⚠⚠ **先解决下面那个设计问题**                                         | 见下                                           |
...
1. ✅✅ **给 `DeckVariant` 加一个「显式遗物 / 药水清单」，空 = 走旧轮换。**
   ...
   （贤者之石 / 地精之角 / 手钻 / 活体样本 / 御守 / 暗石护符 —— 全都只是「不在那八个轮换里」）。
